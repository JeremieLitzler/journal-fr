...
You will start receiving updates right here in your inbox. You can also log in to Substack to read the archives in english or in french.
...
Use this link to access your settings. You will see this:
...
Vous commencerez à recevoir des mises à jour ici même dans votre boîte de réception. Vous pouvez également vous connecter au site Web pour lire les archives complètes (en anglais ou en en français).
...
Utilisez ce lien pour accéder à vos paramètres concernant ma publication. Vous verrez ceci :
...
Vous pouvez toujours tout voir sur le site Web.
